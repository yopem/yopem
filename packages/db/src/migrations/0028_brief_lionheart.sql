...
ALTER TABLE "products" DROP CONSTRAINT "tools_slug_unique";--> statement-breakpoint
...
ALTER TABLE "product_tags" DROP CONSTRAINT "tool_tags_tool_id_tag_id_pk";--> statement-breakpoint
ALTER TABLE "product_categories" DROP CONSTRAINT "tool_categories_tool_id_category_id_pk";--> statement-breakpoint
ALTER TABLE "product_tags" ADD CONSTRAINT "product_tags_product_id_tag_id_pk" PRIMARY KEY("product_id","tag_id");--> statement-breakpoint
ALTER TABLE "product_categories" ADD CONSTRAINT "product_categories_product_id_category_id_pk" PRIMARY KEY("product_id","category_id");--> statement-breakpoint
