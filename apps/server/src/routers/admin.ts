...
export const adminRouter = {
  adminApiKeyList: os
    .route({ method: "GET", path: "/admin/api-key/list" })
  ...
  adminApiKeyCreate: os
    .route({ method: "POST", path: "/admin/api-key/create" })
    .use(requireAuthMiddleware)
    .use(requireAdminMiddleware)
  ...
  adminApiKeyUpdate: os
    .route({ method: "POST", path: "/admin/api-key/update" })
    .use(requireAuthMiddleware)
    .use(requireAdminMiddleware)
  ...
  adminApiKeyDelete: os
    .route({ method: "POST", path: "/admin/api-key/delete" })
    .use(requireAuthMiddleware)
    .use(requireAdminMiddleware)
  ...
  adminApiKeyStats: os
    .route({ method: "GET", path: "/admin/api-key/stats" })
    .use(requireAuthMiddleware)
    .use(requireAdminMiddleware)
  ...
  adminModelList: os
    .route({ method: "GET", path: "/admin/model/list" })
    .use(requireAuthMiddleware)
    .use(requireAdminMiddleware)
  ...
  adminModelCreate: os
    .route({ method: "POST", path: "/admin/model/create" })
    .use(requireAuthMiddleware)
    .use(requireAdminMiddleware)
  ...
  adminModelUpdate: os
    .route({ method: "POST", path: "/admin/model/update" })
    .use(requireAuthMiddleware)
    .use(requireAdminMiddleware)
  ...
  adminModelDelete: os
    .route({ method: "POST", path: "/admin/model/delete" })
    .use(requireAuthMiddleware)
    .use(requireAdminMiddleware)
    .input(z.object({ id: z.string() }))
    .output(successOutputSchema)
  ...
  adminAssetSettingsGet: os
    .route({ method: "GET", path: "/admin/asset-settings" })
    .use(requireAuthMiddleware)
    .use(requireAdminMiddleware)
  ...
  adminAssetSettingsUpdate: os
    .route({ method: "POST", path: "/admin/asset-settings/update" })
    .use(requireAuthMiddleware)
    .use(requireAdminMiddleware)
  ...
  adminAiRequestsHistory: os
    .route({ method: "GET", path: "/admin/ai-requests-history" })
    .use(requireAuthMiddleware)
    .use(requireAdminMiddleware)
