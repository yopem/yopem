...
export const userRouter = {
  ...
  apiKeyList: os
    .route({ method: "GET", path: "/user/api-key/list" })
    .use(requireAuthMiddleware)
  ...
  apiKeyCreate: os
    .route({ method: "POST", path: "/user/api-key/create" })
    .use(requireAuthMiddleware)
    .use(requireAdminMiddleware)
  ...
  apiKeyUpdate: os
    .route({ method: "POST", path: "/user/api-key/update" })
    .use(requireAuthMiddleware)
    .use(requireAdminMiddleware)
  ...
  apiKeyDelete: os
    .route({ method: "POST", path: "/user/api-key/delete" })
    .use(requireAuthMiddleware)
    .use(requireAdminMiddleware)
  ...
  apiKeyStats: os
    .route({ method: "GET", path: "/user/api-key/stats" })
    .use(requireAuthMiddleware)
    .use(requireAdminMiddleware)
