  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: siteDescription },
      {
        name: "keywords",
        content:
          "AI tools, marketplace, automation, artificial intelligence, workflow",
      },
      { name: "author", content: siteDomain },
      ...
      { property: "og:image", content: logoOgUrl },
      { property: "og:image:width", content: logoOgWidth },
      { property: "og:image:height", content: logoOgHeight },
      { property: "og:image:alt", content: siteTitle },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: siteTitle },
      { name: "twitter:description", content: siteDescription },
      { name: "twitter:image", content: logoOgUrl },
      ...(xUsername
