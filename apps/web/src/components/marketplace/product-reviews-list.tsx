...
import ProductRatingInput from "@/components/marketplace/product-rating-input"
      ...
      <div className="border-border bg-card rounded-lg border">
        ...
        >
          {editorOpen ? (
            ...
            <>
              ...
              {isAuthenticated && !hasExistingReview && !hasUsedProduct && (
                <p className="text-muted-foreground mt-3 text-xs">
                  Run this product at least once to leave a review.
                </p>
              )}
            </>
          )}
        ...
        {isAuthenticated && editorOpen && slug && (
          <div className="p-4 sm:p-5">
            <ProductRatingInput slug={slug} onSuccess={onEditorSuccess} />
          </div>
        )}
      </div>
    )
