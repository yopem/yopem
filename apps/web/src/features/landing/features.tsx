            ...
            <div className="bg-muted/30 border-border/50 relative min-h-[240px] flex-1 overflow-hidden border-l md:min-h-full">
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="border-border/50 relative flex size-[220px] items-center justify-center rounded-full border">
                  <div className="bg-card border-border/50 absolute -top-4 rounded-md border px-2.5 py-1 font-mono text-[10px] font-medium shadow-2xs">
                    GPT-4
                  </div>
                  <div className="bg-card border-border/50 absolute -bottom-4 rounded-md border px-2.5 py-1 font-mono text-[10px] font-medium shadow-2xs">
                    Claude 3
                  </div>
                  <div className="bg-card border-border/50 absolute -left-6 rounded-md border px-2.5 py-1 font-mono text-[10px] font-medium shadow-2xs">
                    Mistral
                  </div>
                  <div className="bg-muted text-foreground border-border/50 z-10 flex size-14 items-center justify-center rounded-full border font-bold shadow-2xs">
